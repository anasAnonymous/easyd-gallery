...
const MediaPage = () => {
    ...
    useEffect(() => {
      fetch(`https://pixabay.com/api/?key=${pixabay_key}&q=${searchKeyword}&image_type=photo&pretty=true&per_page=11&page=${pageNo}`)
    ...
    return (
        <div> 
          ...
          :
          <div className="grid grid-cols-1 gap-2 xs:grid-cols-2 sm:grid-cols-3 sm:gap-3 lg:grid-cols-4 lg:gap-4">
